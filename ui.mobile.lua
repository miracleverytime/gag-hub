...
return function(ctx)
    ...
    -- 0.60 x 0.95 memberi layout yang lebih besar di layar mobile — cukup
    -- untuk menghindari Roblox topbar (≈36px) dan hotbar (≈60px) pada layar kecil.
    local originalSize = UDim2.new(0.60, 0, 0.95, 0)
    ...
    local SIDEBAR_W = 115 -- diperbesar dari 105 → 115 agar footer "Powered by Miracle Labs" proporsional di mobile
